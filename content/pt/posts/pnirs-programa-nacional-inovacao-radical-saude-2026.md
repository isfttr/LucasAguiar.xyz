...
1. **Prestação de serviços tecnológicos especializados** ao setor produtivo, com disponibilização de infraestrutura, equipamentos, plataformas tecnológicas e equipes especializadas
2. **Execução de projetos de PD&I** (Pesquisa, Desenvolvimento e Inovação) voltados ao desenvolvimento de tecnologias estratégicas para a saúde
