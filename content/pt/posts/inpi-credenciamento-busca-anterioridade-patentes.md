...
|-----------|-------------|
| Escolaridade | Engenharia, Química, Farmácia, Biotecnologia, TI ou afins |
| Idioma | Leitura técnica em inglês |
| Cadastros | SICAF + ComprasGov ativos |
| Cursos INPI | Busca de anterioridade, Derwent, Formulário de busca |
| Experiência | Cursos OMPI (DL-101 + DL-318) OU 3 anos de experiência |
