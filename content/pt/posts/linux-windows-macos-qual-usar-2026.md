...
tags:
  ...
  - software
---
Tive a ideia para esse texto depois de ficar sabendo pelo canal [Fireship](https://youtu.be/lkifbWtxxlk?si=mf2wmPK9zUIz33mC) do último exploit no kernel do Linux que estava relacionado a um commit de 2017. E na semana passada, estava comentando com amigos que trabalham com ciência de dados o porquê de hoje preferir ficar longe de Linux.
...
- [Ubuntu](https://ubuntu.com/) — a mais popular, com enorme base de suporte e documentação
- [Linux Mint](https://linuxmint.com/) — excelente para quem vem do Windows, interface familiar
- [Zorin OS](https://zorin.com/os/) — focado em facilidade de uso, boa experiência "out of the box"
- [Fedora](https://fedoraproject.org/) — bem considerado na comunidade

Com relação ao Fedora, a minha experiência foi super limitada — não cheguei a usá-lo em uma máquina no dia a dia.

Quanto ao [Arch Linux](https://archlinux.org/), acho que o cenário é anárquico, pra dizer o mínimo. Não consigo recomendar o Arch para uso cotidiano para quem não tem conhecimento técnico avançado. É muito difícil depender de um sistema que tem uma nova atualização todo dia. Ubuntu e companhia têm o melhor equilíbrio entre estabilidade e atualidade dos pacotes — e é isso que importa para quem precisa trabalhar.
...
Com relação ao MacBook Pro de 2014 que usava, era praticamente uma roleta russa o que ia funcionar. Tive problemas com regulagem do dissipador de calor, com a luz de fundo do teclado, com Wi-Fi, com webcam, com sincronização via OneDrive e com gerenciamento de bateria, entre outros.
E o que vejo no futuro não parece melhor, principalmente com a tendência de soldar componentes nas máquinas e usar o máximo de hardware proprietário. O [Asahi Linux](https://asahilinux.org/), que parei de acompanhar há algum tempo, demonstra o quão difícil é a adaptação para os novos chips da Apple. Gostaria de ter segurança em um projeto como esse plenamente funcional, mas não consigo ter essa confiança no curto prazo.
Escrevi mais sobre homelab e Linux em outro post — se quiser ver como é lidar com Linux em ambiente virtualizado, vale a leitura.
...
Nesse fronte tenho coisas boas e ruins a dizer. O computador que uso no trabalho atualmente é bem capaz, então em termos de performance o Windows 11 roda excelente e nunca tive problemas. Gosto de algumas coisas no Windows Explorer que não existem no macOS — e sinceramente, é basicamente isso.
Os pontos negativos principais estão relacionados ao bloat que a Microsoft insiste em colocar nos seus produtos: campanhas publicitárias no próprio sistema, e o Copilot em todo lugar, mas com usabilidade super limitada.
...
Sei que posso ficar com ele sem problemas por pelo menos 5 anos, sem pensar em trocar. Escrevi mais sobre isso em detalhes no post sobre [10 anos com MacBook]({{< relref "/posts/10-years-of-macbook-pro" >}}) — a longevidade real desse hardware é impressionante. Todas as experiências com computadores Windows ao longo dos anos foram bem piores nesse sentido, e isso é basicamente um fato amplamente conhecido.
