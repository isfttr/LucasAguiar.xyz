...
Throughout the trial — which had already been discussed in previous sessions — the relevance of ABPI's work and its pioneering role in defending the Brazilian industrial property system were highlighted.

## The history of the action

The Public Civil Action was filed in 2021, during the tenure of the then-president of ABPI, Luiz Edgard Montaury Pimenta. The central thesis was that the INPI, despite institutional advances in recent years, lacked structural conditions to fully exercise its constitutional and legal attributions.

The oral arguments in the trial were led by Gabriel Leonardos, former president of ABPI, who presented the technical arguments on the need to strengthen the agency as a condition for the legal certainty of the IP system in Brazil. ABIFINA (Brazilian Association of Fine Chemicals, Biotechnology and Specialties Industries) and ABAPI (Brazilian Association of Industrial Property Agents) acted as _amici curiae_.
...
| Dimension | Impact |
|----------|---------|
| **Budgetary** | Pressure for an increase in the agency's budget, currently insufficient given the volume of applications |
...
- The **report of proposals for improving the IP Law** (June/2026), which consolidates internal suggestions to modernize Law 9.279/1996
...
1. **The Judiciary is attentive to the functioning of the INPI.** Decisions like this create jurisprudence that can be invoked in other actions — including requests for compensation for delays in patent examination.
