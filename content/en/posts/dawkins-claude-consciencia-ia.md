...
Recently, for example, a study revealed that [a small cleaner wrasse (*Labroides dimidiatus*) has a level of self-awareness](https://www.youtube.com/watch?v=Drbl5udwk9I) (passing the mirror test) far exceeding what scientists expected. Just as we underestimate marine life, we will probably never be able to admit that certain computational models (or less charismatic animals) are conscious simply because it “doesn't feel right” for our world view.
