...
draft: true
title: How Google Alerted 11 Million Android Users Before the Venezuela Earthquake [2026]
description: Android seismic alert system used phone accelerometers as seismometers to alert 11.4 million people seconds before the M7.5 earthquake in Venezuela.
featured_image: ''
categories:
  - article
tags:
...
But minutes before the ground began to shake, **11.4 million Android users** received a warning on their phones. For many, those seconds made the difference between life and death.
...
On June 24, 2026, the system worked on a massive scale:

| Metric | Number |
|---|---|
| Users alerted | **11.4 million** |
| Priority "Take Action" alerts | **~1.4 million** |
| First event magnitude | M7.2 (foreshock) |
| Second event magnitude | M7.5 (mainshock — 39s later) |
| Epicenter | Veroes, Yaracuy — 20 km ESE of Yumare |
| Depth | 10 km |
...
The **New York Times** published on June 27, 2026 an interactive special detailing how the system worked during the Venezuelan earthquake, titled *"How Phones Alerted Millions Before Quakes Shook Venezuela"*, by Amy Graff and Martín González Gómez. The report includes wave propagation maps, alert simulations, and testimonials from residents who received the warning seconds before the ground shook.
...
The Venezuela earthquake is a milestone for crowdsourcing-based alert systems. Unlike traditional seismological networks (which require dedicated and expensive stations), Google's approach uses hardware that is already in the pockets of billions of people. It is not perfect — earthquakes with epicenters very close to the user leave little time for warning — but in events like this, the extra seconds save lives.

The system also had important previous lessons: in 2023, it was criticized for underestimating the magnitude of the earthquake in Turkey, and in 2025 it faced a false alarm in Brazil that caused unnecessary panic. The Venezuela case represents the maturation of the technology — with 11.4 million alerts issued and confirmation of dozens of user reports who sought shelter in time.
