...
draft: false
title: 'INPI updates Trademark Manual: new rules for High Renown and accession to the Madrid Protocol'
description: INPI published on June 23, 2026, the update to the Trademark Manual, with significant changes in the recognition of well-known trademarks and new guidelines for international registration via the Madrid Protocol through the Madrid e-Filing system.
featured_image: ''
categories:
  - article
tags:
...
Ordinance No. 68/2026 serves as the **normative basis** for both changes. Although the full text still requires detailed analysis (available on the [INPI Trademark Legislation page](https://www.gov.br/inpi/pt-br/servicos/marcas/legislacao)), the Manual's update signals a clear directive: INPI seeks to **modernize and debureaucratize** the trademark system, aligning Brazil with international best practices.
...
1.  **First well-known mark applications with multiple bases**: how will INPI apply the new rule in practice? The trend is that the first cases will define administrative jurisprudence.
2.  **Formal adherence to the Madrid Protocol**: Brazil has been a signatory since 2019, but the Manual's guidelines indicate that full operationalization through Madrid e-Filing is finally consolidated.
3.  **Impact on already recognized well-known marks**: can holders with previous registrations request re-examination in light of the new regulation?
