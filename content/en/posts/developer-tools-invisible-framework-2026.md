...
### The Steep Learning Curve as Virtue
...
### Is the learning curve an investment or a tax?
...
### Does it optimize for the common case?
...
### Do the claims hold up under measurement?
...
**My take**: most developers would be best served by whatever editor they already know well, with a minimal configuration that handles their 80% case, and the discipline to resist switching every six months. And taking into account the power of AI nowadays, you can create a pretty sweet setup for your use case in Neovim.
...
**My take**: pick one git tool. Learn it well. Stop thinking about git and start thinking about commits. The tool that achieves that is the right one.
...
**My take**: AI tools are the most likely category to *actually* make parts of your workflow invisible. The risk is over-adoption — using AI for tasks where the human cost of verifying output exceeds the time saved. Use AI for tasks with clear success criteria (refactoring, boilerplate, tests). Use your own judgment for tasks where correctness is expensive.
