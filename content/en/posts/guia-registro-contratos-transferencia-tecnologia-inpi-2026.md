...
Contracts for the provision of specialized technical services: projects, consulting, training, assembly supervision, maintenance. The INPI requires the contract to clearly specify the scope, duration, and technical qualification of the provider.
