...
description: In 2021, the STF (Supreme Federal Court) struck down the provision that guaranteed a minimum 10-year validity period after patent grants. Understand what changed, which patents were affected, and the impact on drug prices.
...
tags:
  ...
  - regulacao
translation_source_hash: 60e81a21c79866c22925986ebf43e1fb20acfe5af1f4052a99e6ca86b2687ec7
slug: adi-5529-stf-shortened-drug-patents-brazil
aliases:
  - /posts/adi-5529-patentes-farmaceuticas/
---
On May 6, 2021, the [Supreme Federal Court](https://portal.stf.jus.br/processos/detalhe.asp?incidente=4984195) declared the sole paragraph of article 40 of the [Industrial Property Law (Law 9,279/1996)](https://www.planalto.gov.br/ccivil_03/leis/l9279.htm) unconstitutional. The decision ended a mechanism that, in practice, automatically extended pharmaceutical patents beyond the 20 years provided for in international agreements — and paved the way for the entry of generics into dozens of markets.
...
The INPI presented data to the Supreme Court illustrating the extent of the problem: **8,837 applications pending for more than 10 years** and an average decision time of up to 14 years in some technological groups. [ABIFINA](https://abifina.org.br/acontece-na-abifina/stf-decide-pelo-fim-da-prorrogacao-de-patentes/), author of the original lawsuit (ADI 5061/2013), documented that the provision had been invoked in **96% of pharmaceutical patents granted between 2000 and 2016**.
...
The INPI published an initial list of **3,341 patents** for immediate correction or extinction in [RPI 2628 of 05/18/2021](https://www.gov.br/inpi/pt-br/central-de-conteudo/noticias), with subsequent weekly lists. [Law 14,195/2021](https://www.planalto.gov.br/ccivil_03/_ato2019-2022/2021/lei/L14195.htm), enacted in August of the same year, expressly revoked the sole paragraph of the LPI.
...
The underlying issue remains the same that motivated the ADI: as long as the INPI takes years to examine pharmaceutical applications — and the [specific backlog in this sector]({{< relref "posts/backlog-inpi-patentes-farmaceuticas/" >}}) has never been tackled with the same energy as the general one — the tension between innovation and access to medicines will continue to produce litigation.
