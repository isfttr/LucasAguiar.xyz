...
description: The ESR 6C006 Geo Digital Pencil does not have auto shutoff (sleep mode). Understand the technical reason, the relationship with Apple Find My, and if it's possible to modify the firmware.
...
- [Linux, Windows ou macOS: Qual Sistema Operacional Usar em 2026?]({{< relref "posts/linux-windows-macos-qual-usar-2026/" >}})
