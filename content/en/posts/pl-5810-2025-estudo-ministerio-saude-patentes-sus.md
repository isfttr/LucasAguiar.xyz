...
description: Analysis of the technical opinion from CGPR/MS on the Bill that creates a mechanism for patent term adjustment and its fiscal impact on the public health system.
featured_image: ''
categories:
  - article
tags:
...
Lígia Formenti's article in [JOTA](https://www.jota.info/saude/ministerio-da-saude-pl-que-amplia-prazo-de-patente-pode-custar-r-3-bi-a-mais-para-sus), brought the details of the study to public.
...
1.  **Increases prices** — by delaying the entry of generics and biosimilars, it maintains the original manufacturer's price for longer
...
3.  **Compromises public resource allocation** — every real spent more on monopolized medications is a real that is no longer invested in the incorporation of new technologies, expansion of access, or other health policies
