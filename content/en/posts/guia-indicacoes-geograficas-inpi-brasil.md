...
description: 'Complete guide to Geographical Indications in Brazil: types (indication of source vs denomination of origin), step-by-step registration at INPI, costs, legislation, and benefits for producers.'
featured_image: ''
categories:
  - article
tags:
  ...
  - marcas
  - guia
slug: geographical-indication-inpi-complete-guide-2026
translation_source_hash: 504071b2193220cb2c388c42e4d6dae2a576e67e4175c498edc2549b8df17d98
---
...
> Consult chapter 7 of the [INPI Manual of Geographical Indications](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/guia-basico) (in effect since 02/01/2021) for the detailed list. Also check the [Technical Specifications Notebooks](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/fichas-tecnicas-de-indicacoes-geograficas) of already registered GIs as a reference.
...
Steps:
1. Register at [e-INPI](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/e-ig) (if you do not already have one)
2. Access the e-IG system with your account
3. Fill out the electronic form with the applicant's and GI's data
4. Attach the mandatory documentation
5. Enter the paid GRU number
...
Follow the progress through the **Industrial Property Journal (RPI)**, published on Tuesdays, and through the [process search database](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/busca).
...
The holder must ensure compliance with the use regulation and may take measures to combat counterfeiting. The INPI maintains a [National Directory for Combating Counterfeiting of Geographical Indications (DNCF-IGs)](https://www.gov.br/inpi/pt-br/projetos-estrategicos/combate-a-falsificacao/dncf-igs) as a support tool.
...
Consult the [complete list](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/certificados-de-registros-concedidos) of granted GIs and applications under analysis.
...
**National:**
- **Law No. 9.279/96 (LPI)** — Arts. 176 to 182 ([full text](https://www.planalto.gov.br/ccivil_03/leis/l9279.htm))
...
Consult the [INPI legislation page](https://www.gov.br/inpi/pt-br/servicos/indicacoes-geograficas/legislacao-indicacao-geografica-1) for the complete list of regulations.
