...
draft: true
title: 'The GLP-1 revolution in Brazil: how patents, biosimilars, and competition are transforming the pharmaceutical market'
description: With a market projected to jump from US$1.8 billion to US$9 billion by 2030, the GLP-1 patent ecosystem is redefining access, consumption, and competition in Brazil
featured_image: ''
categories:
  - article
tags:
...
EMS launched **Ozivy**, the first national semaglutide, generating not only a lower-cost alternative but also a brand dispute: Novo Nordisk requested the annulment of the Ozivy brand registration, in a case that exposes the tension between original innovation and legitimate competition. This case was [analyzed separately on the blog]({{< relref "posts/novo-nordisk-ozivy-anulacao-marca-semaglutida/" >}}).

### Eurofarma + Novo Nordisk: Partnership with price reduction

In an unprecedented strategy, **Eurofarma** partnered with Novo Nordisk to distribute Poviztra (equivalent to Wegovy) and Extensior (equivalent to Ozempic) in Brazil, with price reductions of up to 48%.

Through the **EuroCuida** program, Poviztra can be purchased for **R$ 295 per box** (0.25 mg and 0.5 mg presentations) and **R$ 309** (1 mg, with repurchase within 80 days). Starting July 1st, the program also offers discounts of up to 50% on nutritional supplements, aiming to preserve lean mass during weight loss.

### What IQVIA data shows

IQVIA data presented during an Eurofarma and Novo Nordisk event in São Paulo confirm the acceleration:
